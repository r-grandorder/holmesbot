        ...
        trimmed.append(
            {
                ...
                "atk_base": s.get("atkBase", 0),
                "atk_max": s.get("atkMax", 0),
                "hp_base": s.get("hpBase", 0),
                "hp_max": s.get("hpMax", 0),
                "gender": s.get("gender", ""),
        ...
        out.append(
            {
                ...
                "className": s.get("className", ""),
                "rarity": s.get("rarity", 0),
                "atk_base": nice.get("atkBase", 0),
                "atk_max": nice.get("atkMax", 0),
                "hp_base": nice.get("hpBase", 0),
                "hp_max": nice.get("hpMax", 0),
